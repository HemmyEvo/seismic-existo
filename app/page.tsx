...
export default function SeismicHomePageBrown() {
  ...
  return (
    ...
    >
      ...
      {/* --- 1. HERO SECTION --- */}
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-28 md:pt-36 pb-16 relative z-10">
        <motion.div style={{ opacity: heroOpacity, scale: heroScale, width: '100%' }}>
          <motion.div 
            ...
            style={{ width: '100%' }}
          >
            <div className="w-full max-w-5xl mx-auto space-y-6 md:space-y-8 relative px-4 flex flex-col items-center">
              ...
              >
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mt-6 md:mt-10 px-4">
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} style={{ display: 'inline-block' }}>
                    <Link href="/projects" className="inline-block px-6 py-3 md:px-8 md:py-4 bg-linear-to-r from-[#8b5a2b] to-[#b88b4a] text-white font-bold rounded-full shadow-[0_8px_32px_rgba(139,90,43,0.3)] transition-all duration-300 text-sm md:text-base">
                      My projects
                    </Link>
                  </motion.div>
                  
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} style={{ display: 'inline-block' }}>
                    <Link href="https://docs.seismic.systems/" className="px-6 py-3 md:px-8 md:py-4 bg-white/10 backdrop-blur-md border flex items-center justify-center border-white/20 font-bold rounded-full text-white hover:bg-white/20 transition-all duration-300 shadow-[0_8px_32px_rgba(0,0,0,0.2)] text-sm md:text-base">
                  ...
                  <div className="hidden sm:flex justify-center items-center">
                    ...
                    >
                      <div className="w-6 h-10 rounded-full border-2 border-stone-600/50 flex justify-center backdrop-blur-sm">
                        ...
                        >
                          <div className="w-1.5 h-1.5 bg-stone-400 rounded-full mt-2" />
                        </motion.div>
                      </div>
                    </motion.div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="text-center mb-12 md:mb-16 px-4">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} style={{ display: 'inline-block', marginTop: '2rem' }}>
                <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 px-2 mb-12">
                {[
                  ...
                  <motion.div 
                    ...
                    style={{ display: 'block' }}
                  >
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all cursor-default flex flex-col items-center h-full">
