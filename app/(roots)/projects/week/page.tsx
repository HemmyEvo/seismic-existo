...
const themes = {
  ...
  "month-start": { label: "Month Starting", title: "NEW CYCLE BEGUN" },
  "month-end": { label: "Month Ending", title: "CYCLE COMPLETE" }
};
...
const quotes = {
  ...
  "month-start": [
    "A new chapter in the ledger. What will you write?",
    "Broaden your bandwidth. This month holds infinite potential.",
    "Initialize greatness. The new cycle is live."
  ],
  "month-end": [
    "Milestones achieved. Data processed. Prepare for the next era.",
    "Look at the network you've built. The month was a success.",
    "Close the loops. A phenomenal month comes to a halt."
  ]
};
...
export default function SeismicGreetingGenerator() {
  ...
  const [theme, setTheme] = useState<keyof typeof themes>('week-start');
  ...
  // Set initial random quote on load or theme change
  useEffect(() => {
    getRandomQuote();
  }, [theme]);
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      ctx.fillText(themes[theme].title, canvas.width / 2, 210);
      ...
      // Approximate center starting Y based on length
      const quoteY = 480; 
      wrapText(ctx, `"${currentQuote}"`, canvas.width / 2, quoteY, 800, 70);

      // 5. User Profile Area (Bottom Left)
      ...
      <main className="relative z-10 pt-28 pb-16 px-4 sm:px-6 max-w-7xl mx-auto flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            {/* CSS Preview of the 1080x1080 Canvas */}
            <div className="bg-[#050505] relative w-full aspect-square max-w-[500px] mx-auto rounded-xl overflow-hidden border border-white/10 shadow-2xl p-6 sm:p-10 flex flex-col items-center justify-between">
              ...
              {/* Decorative Frame Accents (CSS representation) */}
              ...
              <div className="relative z-10 text-center mt-4">
                ...
                <h3 className="text-sm font-semibold tracking-widest mt-1" style={{ color: activeMag.color }}>
                  {themes[theme].title}
                </h3>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-[500px] mx-auto w-full">
              <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-white text-black font-bold rounded-xl hover:bg-stone-200 transition-all disabled:opacity-70"
              >
              ...
              <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-[#1DA1F2] text-white font-bold rounded-xl hover:bg-[#1a8cd8] transition-all"
              >
